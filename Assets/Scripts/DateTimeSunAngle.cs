...
// adapted from https://gist.github.com/paulhayes/54a7aa2ee3cccad4d37bb65977eb19e2
public class DateTimeSunAngle : MonoBehaviour {

	private static DateTimeSunAngle instance;
	...
	void UpdatePosition () {
		...
		SunPosition.CalculateSunPosition (DateTime.UtcNow.Date + timespan, (double)latitude, (double)longitude, out double azi, out double alt);
